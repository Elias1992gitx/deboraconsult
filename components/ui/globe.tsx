...
const Globe = ({ globeConfig, data }: WorldProps) => {
  ...
  useEffect(() => {
    ...
    globeMaterial.emissive = new Color(defaultConfig.emissive);
    globeMaterial.emissiveIntensity = defaultConfig.emissiveIntensity;
    globeMaterial.shininess = defaultConfig.shininess;
    ...
    globe
      ...
      .arcTime(defaultConfig.arcTime)
      .arcLength(defaultConfig.arcLength)
      .arcsData(data)
      .arcColor('color')
      .arcAltitude('arcAlt')
      .arcStroke(0.5)
      ...
      .polygonCapColor(() => defaultConfig.polygonColor)
      .polygonSideColor(() => defaultConfig.polygonColor)
